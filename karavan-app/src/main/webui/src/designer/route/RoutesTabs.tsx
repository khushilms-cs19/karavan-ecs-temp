/*
    Name:- RoutesTabs.tsx
    Description:- This file is used to display the tabs for the routes in the designer page using patternfly.
    Input parameters:-
        selectedRoutes: Routes selected by the user which can be used to display the routes in the tabs.
        handleRoutesCloseClick:  Function to execute when the user clicks on the close button of the tab.
        activeTabKey: The active tab key which is used to display the active tab on the screen
        handleActiveTabKey: Function to execute when the user clicks on the tab.
*/
