...
import DslButtonConfiguration from '../utils/DslButtonConfiguration/DslButtonConfiguration';
import { Project } from '../../projects/ProjectModels';
import CodeEditorModal from '../utils/CodeEditor/CodeEditorModal';
...
export class DslProperties extends React.Component<Props, State> {
    ...
    getProperties = (): PropertyMeta[] => {
        ...
        const data =  CamelDefinitionApiExt.getElementProperties(dslName)
        ...
        return (
            <div key={this.state.step ? this.state.step.uuid : 'integration'}
                ...
                <Form autoComplete="off" onSubmit={event => event.preventDefault()}>
                    ...
                    <DslButtonConfiguration dslName={this.state.step?.dslName || 'unassigned'}
                        setIsLoading={this.setIsLoading} setCode={this.setCode} setShowModal={this.setShowModal}  payload={{...this.state.step,projectId: this.props.project?.projectId}} />
                    {
                        this.state.showModal && 
                        <CodeEditorModal showModal={this.state.showModal} isLoading={this.state.isLoading} setIsLoading={this.setIsLoading} setShowModal={this.setShowModal} setCode={this.setCode} code={this.state.code || ''} payload={{...this.state.step,projectId: this.props.project?.projectId}} />
                    }
                </Form>
            </div>
        )
