...
export class KIcon extends React.Component {
  componentDidMount() {
    // ----- setup ----- //
...
var dragStartRX: number, dragStartRY: number;
...
new Zdog.Dragger({
  ...
  onDragMove: function( pointer: Zdog.PointerPosition, moveX: number, moveY: number ) {
  ...
  render() {
    return (
      <div className="zdog-canvas-container">
