...
var CamelUtil = /** @class */ (function () {
    ...
    CamelUtil.cloneIntegration = function (integration) {
        ...
        var flows = [];
        (_b = int.spec.flows) === null || _b === void 0 ? void 0 : _b.filter(function (e) { return e.dslName !== 'Beans'; }).forEach(function (f) { return flows.push(CamelDefinitionApi_1.CamelDefinitionApi.createStep(f.dslName, f)); });
        (_c = int.spec.flows) === null || _c === void 0 ? void 0 : _c.filter(function (e) { return e.dslName === 'Beans'; }).forEach(function (beans) {
        ...
        (_d = int.spec.flows) === null || _d === void 0 ? void 0 : _d.filter(function (e) { return e.dslName === 'RouteConfiguration'; }).forEach(function (routeConfiguration) {
            var newRouteConfiguration = CamelUtil.cloneRouteConfiguration(routeConfiguration);
            flows.push(newRouteConfiguration);
        });
        int.spec.flows = flows;
        return int;
    };
    CamelUtil.cloneStep = function (step, generateUuids) {
        if (generateUuids === void 0) { generateUuids = false; }
        var clone = JSON.parse(JSON.stringify(step, function (key, value) {
    ...
    CamelUtil.cloneRouteConfiguration = function (routeConfiguration) {
        var clone = JSON.parse(JSON.stringify(routeConfiguration));
        var RouteConfiguration = new CamelDefinition_1.RouteConfigurationDefinition(clone);
    ...
    CamelUtil.getKameletRequiredParameters = function (element) {
        var kamelet = CamelUtil.getKamelet(element);
        return kamelet
    ...
    CamelUtil.checkRequired = function (element) {
        ...
        if (['FromDefinition', 'ToDefinition'].includes(className)) {
            ...
            if (!isKamelet) {
                ...
                var kamelet = _a.getKamelet(element);
                var allSet_1 = true;
                var filledParameters_1 = Object.keys(element.parameters);
                (_b = kamelet === null || kamelet === void 0 ? void 0 : kamelet.spec.definition.required) === null || _b === void 0 ? void 0 : _b.forEach(function (name) {
                    if (!filledParameters_1.includes(name)) {
                        allSet_1 = false;
