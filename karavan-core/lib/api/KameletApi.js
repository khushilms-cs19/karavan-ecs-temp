...
exports.KameletApi = exports.CustomNames = exports.Kamelets = void 0;
/*
...
exports.CustomNames = [];
exports.KameletApi = {
    getCustomKameletNames: function () {
        return exports.CustomNames;
    },
    saveCustomKameletNames: function (names) {
        exports.CustomNames.length = 0;
        exports.CustomNames.push.apply(exports.CustomNames, names);
    },
    ...
    saveKamelet: function (yaml) {
        ...
        if (exports.Kamelets.findIndex(function (k) { return k.metadata.name === kamelet.metadata.name; }) === -1) {
