...
exports.SensitiveKeys = exports.CamelModelMetadata = exports.CamelLanguageMetadata = exports.Languages = exports.CamelDataFormatMetadata = exports.DataFormats = exports.CamelMetadataApi = exports.PropertyMeta = exports.ElementMeta = void 0;
/**
...
var PropertyMeta = /** @class */ (function () {
    function PropertyMeta(name, displayName, description, type, enumVals, defaultValue, required, secret, isArray, isObject, label, javaType) {
        this.name = '';
        this.displayName = '';
        this.description = '';
        this.type = '';
